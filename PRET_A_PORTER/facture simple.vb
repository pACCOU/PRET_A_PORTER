...
Public Class facture_simple
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRET_A_PORTER.facture simple.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfacture_simple
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As facture_simple = New facture_simple
        rpt.Site = Me.Site
        Return rpt
    End Function
