...
Public Class facturationperiode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRET_A_PORTER.facturationperiode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfacturationperiode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As facturationperiode = New facturationperiode
        rpt.Site = Me.Site
        Return rpt
    End Function
